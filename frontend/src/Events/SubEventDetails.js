...
{
  subEvent.title === "Football (Boys Only)" || subEvent.title === "Cricket" || subEvent.title === "Biocrux Sr.(MedQuiz)" || subEvent.title === "COD MOBILE (MULTIPLAYER)" || subEvent.title === "BGMI (BATTLE ROYALE)" || subEvent.title === "BGMI (TEAM DEATH MATCH)" ? (
